...
public class KafkaConfig {
  ...
  public NewTopic inventorySuccessTopic() {
    return TopicBuilder.name(inventorySuccessTopic).partitions(PARTITIONS).replicas(REPLICATION).build();
  }

  @Bean
  public NewTopic inventoryFailTopic() {
    return TopicBuilder.name(inventoryFailTopic).partitions(PARTITIONS).replicas(REPLICATION).build();
  }
